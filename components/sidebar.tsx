      ...
      <div className="fixed left-0 top-0 z-50 flex h-screen w-16 flex-col border-r border-blue-900/50 bg-blue-950/20 backdrop-blur-md">
                ...
                <TooltipTrigger asChild>
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "bg-blue-900/50 text-cyan-400"
                        : "text-blue-400 hover:text-cyan-300"
                    )}
                  >
                    <route.icon className="h-5 w-5 transition-all" />
                    {isActive && (
                      <div className="absolute inset-y-1 left-0 w-1 rounded-r-full bg-cyan-400" />
                    )}
                  </Link>
                </TooltipTrigger>
                <TooltipContent
                  side="right"
                  className="border-blue-900/50 bg-blue-950/90 text-white"
                >
                  {route.label}
                </TooltipContent>
              </Tooltip>
        ...
        <div className="border-t border-blue-900/50 p-4">
          <Tooltip delayDuration={0}>
            ...
            <TooltipContent
              side="right"
              className="border-blue-900/50 bg-blue-950/90"
            >
