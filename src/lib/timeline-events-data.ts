...
export const timelineEvents: TimelineEra[] = [
  {
    era: "Ancient Era",
    description: "The earliest known galactic civilizations",
    significance: "Foundation of galactic history",
    events: [
      {
        ...
        icon: Star,
        image:
          "/placeholder.svg?height=400&width=600&text=Leviathan+Civilization",
        details: {
      ...
      },
      {
        ...
        icon: AlertTriangle,
        image:
          "/placeholder.svg?height=400&width=600&text=First+Reaper+Harvest",
        details: {
  ...
  },
  {
    ...
    description: "Civilizations that preceded the Prothean Empire",
    significance: "Foundation for Prothean development",
    events: [
      {
        year: "Unknown BCE",
        ...
        type: "major",
        icon: Globe2,
        image: "/placeholder.svg?height=400&width=600&text=Inusannon+Empire",
        details: {
      ...
      },
      {
        ...
        icon: Star,
        image:
          "/placeholder.svg?height=400&width=600&text=Prothean+Empire+Rise",
        details: {
      ...
      },
      {
        ...
        type: "discovery",
        icon: Atom,
        image: "/placeholder.svg?height=400&width=600&text=Prothean+Technology",
        details: {
  ...
  {
    era: "Prothean Era",
    description: "The height of Prothean civilization",
    significance: "Most advanced known galactic civilization",
    events: [
      {
        year: "68,000 BCE",
        ...
        icon: Globe2,
        image:
          "/placeholder.svg?height=400&width=600&text=Prothean+Empire+Peak",
        details: {
      ...
      },
      {
        ...
        type: "conflict",
        icon: AlertTriangle,
        image: "/placeholder.svg?height=400&width=600&text=Prothean+Reaper+War",
        details: {
      ...
      },
      {
        ...
        icon: Atom,
        image:
          "/placeholder.svg?height=400&width=600&text=Conduit+Construction",
        details: {
  ...
  },
  {
    ...
    description: "The establishment of modern galactic government",
    significance: "Foundation of current galactic order",
    events: [
      {
        year: "580 BCE",
        ...
        type: "discovery",
        icon: Milestone,
        image: "/placeholder.svg?height=400&width=600&text=Citadel+Discovery",
        details: {
      ...
      },
      {
        ...
        icon: Star,
        image:
          "/placeholder.svg?height=400&width=600&text=Asari+Salarian+Contact",
        details: {
  ...
  {
    era: "Rachni Wars",
    description: "The first major galactic conflict",
    significance: "Shaped Council military policy",
    events: [
      {
        year: "1 CE",
        ...
        type: "discovery",
        icon: Rocket,
        image: "/placeholder.svg?height=400&width=600&text=Rachni+Discovery",
        details: {
      ...
      },
      {
        ...
        type: "conflict",
        icon: AlertTriangle,
        image: "/placeholder.svg?height=400&width=600&text=Rachni+Wars",
        details: {
  ...
  {
    era: "Modern Era",
    description: "The current galactic era",
    significance: "Contemporary galactic events",
    events: [
      {
        year: "2148 CE",
        ...
        type: "discovery",
        icon: Rocket,
        image: "/placeholder.svg?height=400&width=600&text=Mars+Prothean+Ruins",
        details: {
      ...
      },
      {
        ...
        type: "conflict",
        icon: AlertTriangle,
        image: "/placeholder.svg?height=400&width=600&text=First+Contact+War",
        details: {
      ...
      },
      {
        ...
        type: "conflict",
        icon: AlertTriangle,
        image: "/placeholder.svg?height=400&width=600&text=Eden+Prime+Attack",
        details: {
      ...
      },
      {
        ...
        icon: AlertTriangle,
        image:
          "/placeholder.svg?height=400&width=600&text=Battle+of+the+Citadel",
        details: {
          location: "Citadel",
      ...
      },
      {
        ...
        type: "discovery",
        icon: Eye,
        image: "/placeholder.svg?height=400&width=600&text=Collector+Ships",
        details: {
      ...
      },
      {
        ...
        icon: AlertTriangle,
        image:
          "/placeholder.svg?height=400&width=600&text=Bahak+System+Destruction",
        details: {
      ...
      },
      {
        ...
        type: "conflict",
        icon: AlertTriangle,
        image: "/placeholder.svg?height=400&width=600&text=Collector+Attacks",
        details: {
      ...
      },
      {
        ...
        type: "conflict",
        icon: AlertTriangle,
        image: "/placeholder.svg?height=400&width=600&text=Reaper+Invasion",
        details: {
