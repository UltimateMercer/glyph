        ...
        <Sheet open={open} onOpenChange={onOpenChange}>
          ...
          >
            ...
            <div className="flex gap-5">
              <div className="relative w-32 h-32 rounded-lg overflow-hidden border border-blue-900/50 flex-shrink-0 hover:ring-4 hover:ring-blue-500/25">
                <Image
                  src={getPersonImage(person) || "/placeholder.svg"}
                  alt={person.name}
                  fill
                  className="object-cover hover:ring-2 hover:ring-blue-500/25"
                />
              </div>
              <div className="flex-1">
                <h1 className="text-3xl font-bold dark:text-white text-slate-900 mb-3">
                  {person.name}
                </h1>
                <div className="flex flex-wrap gap-2">
                  <Badge
                    variant="outline"
                    className="dark:border-blue-700 dark:bg-blue-900/50 dark:text-blue-300 text-blue-700 border-blue-300 bg-white/80 text-md"
                  >
                    {person.species}
                  </Badge>
                  <Badge
                      ...
                      <Card className="border-blue-900/50 bg-blue-950/20 backdrop-blur-sm">
                        <CardHeader>
                          ...
                          <CardDescription className="text-blue-400">
                            Showing first 3 achievements - view Background tab
                            for complete list
                          </CardDescription>
                        </CardHeader>
                        <CardContent>
