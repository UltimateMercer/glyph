...
export const PersonCard = React.memo(
  ({ person, onOpenDrawer }: PersonCardProps) => {
    ...
    return (
      <Card
        key={person.id}
        className="group relative dark:border-blue-900/50 dark:bg-blue-950/20 border-blue-200 bg-white/60 backdrop-blur-sm transition-all duration-200 hover:border-blue-700/50 py-0"
      >
